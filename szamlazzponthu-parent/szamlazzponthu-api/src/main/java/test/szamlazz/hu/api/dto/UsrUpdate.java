...
/**
 * Részleges frissítéshez; minden mező opcionális.
 */
@JsonPropertyOrder({
  UsrUpdate.JSON_PROPERTY_FIRSTNAME,
  UsrUpdate.JSON_PROPERTY_LASTNAME,
  UsrUpdate.JSON_PROPERTY_ADDRESS,
  UsrUpdate.JSON_PROPERTY_TELEPHONE,
  UsrUpdate.JSON_PROPERTY_ACTIVE,
  UsrUpdate.JSON_PROPERTY_JOB
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.6.0")
public class UsrUpdate {
  ...
  public UsrUpdate firstname(String firstname) {
  ...
  **/
  ...
  public UsrUpdate lastname(String lastname) {
  ...
  **/
  ...
  public UsrUpdate address(String address) {
  ...
  **/
  ...
  public UsrUpdate telephone(String telephone) {
  ...
  **/
  ...
  public UsrUpdate active(Boolean active) {
    this.active = active;
    return this;
  }
  ...
  **/
  ...
  public UsrUpdate job(String job) {
    this.job = job;
    return this;
  }
  ...
  **/
  ...
  /**
   * Return true if this UsrUpdate object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    UsrUpdate usrUpdate = (UsrUpdate) o;
    return Objects.equals(this.firstname, usrUpdate.firstname) &&
        Objects.equals(this.lastname, usrUpdate.lastname) &&
        Objects.equals(this.address, usrUpdate.address) &&
        Objects.equals(this.telephone, usrUpdate.telephone) &&
        Objects.equals(this.active, usrUpdate.active) &&
        Objects.equals(this.job, usrUpdate.job);
  }
